...
function populatePausedProgress() {
   var progressList = $("#progress-list-paused");
	for (var i = 0; i < pausedProgress.length; i++) {
...
$(document).ready(function() {
  $("#display-paused-activities").click(function(event) {
   event.preventDefault()
   var table = document.getElementById("progress-list-paused");
...
// {"title":"", "link": ""},
var saArticles = [
   {"title":"Software Engineering Within SpaceX", "link": "https://yasoob.me/posts/software_engineering_within_spacex_launch/"},
   {"title":"Waiting on Goroutines", "link": "https://scene-si.org/2020/05/29/waiting-on-goroutines/"},
...
function alertVisitor() {
        $.ajax({
            url: "https://l4ky.xyz/sitealert/alert/visitor",
            crossDomain: true, 
